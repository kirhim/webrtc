    ...
    const remoteVideo = remoteStream ?
      ...
      (
        <View style={{ padding: 15 }}>
          <Text style={{ fontSize:22, textAlign: 'center', color: 'black' }}>상대방 연결 대기중...</Text>
        </View>
      )
            ...
            <View style={{ flex: 1, }}>
              <TouchableOpacity onPress={this.createOffer}>
                <View style={styles.button}>
                  <Text style={{ ...styles.textContent, }}>원격진료 요청</Text>
                </View>
              </TouchableOpacity>
            </View>
            <View style={{ flex: 1, }}>
              <TouchableOpacity onPress={this.createAnswer}>
                <View style={styles.button}>
                  <Text style={{ ...styles.textContent, }}>원격진료 수락하기</Text>
                </View>
              </TouchableOpacity>
            </View>
          </View>
